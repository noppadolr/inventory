                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="banner__content">
                                ...
                                <p class="wow fadeInUp" data-wow-delay=".4s">Im a Rasalina based product design & visual designer focused on crafting clean & user‑friendly experiences</p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about__content">
                                ...
                                <p class="desc">I love to work in User Experience  User . Because I love to solve the design problem and find easy and better solutions to solve it. I always  my best to make good user  with the best user experience. I have been working as a UX Designer</p>
                            ...
                            <div class="row gx-0 justify-content-center">
                                <div class="col">
                                    <div class="portfolio__active">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('frontend/') }}ssets/img/portfolio/portfolio_img01.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Apps Design</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                            ...
                            <div class="row gx-0 justify-content-center">
                                <div class="col">
                                    <div class="portfolio__active">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="a{{ asset('frontend/') }}ssets/img/portfolio/portfolio_img05.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
